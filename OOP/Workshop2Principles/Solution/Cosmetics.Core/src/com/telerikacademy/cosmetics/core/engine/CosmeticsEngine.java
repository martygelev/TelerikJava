...
public final class CosmeticsEngine implements Engine {
    ...
    private String processSingleCommand(Command command) {
        switch (command.getCommandName()) {
            ...
            case "CreateCream":
                ...
                ScentType creamScent = getScent(command.getParameters().get(4));
    ...
    private String createShampoo(String shampooName, String shampooBrand, double shampooPrice, GenderType shampooGender, int shampooMilliliters, UsageType shampooUsage) {
        ...
        Shampoo shampoo = factory.createShampoo(shampooName, shampooBrand, shampooPrice, shampooGender, shampooMilliliters, shampooUsage);
        products.put(shampooName, shampoo);
    ...
    private String createToothpaste(String toothpasteName, String toothpasteBrand, double toothpastePrice, GenderType toothpasteGender, List<String> toothpasteIngredients) {
        ...
        Toothpaste toothpaste = factory.createToothpaste(toothpasteName, toothpasteBrand, toothpastePrice, toothpasteGender, toothpasteIngredients);
        products.put(toothpasteName, toothpaste);
    ...
    private String createCream(String creamName, String creamBrand, double creamPrice, GenderType creamGender, ScentType creamScent) {
        ...
        Cream cream = factory.createCream(creamName, creamBrand, creamPrice, creamGender, creamScent);
        products.put(creamName, cream);
    ...
    private ScentType getScent(String scentAsString) {
        return ScentType.valueOf(scentAsString);
    }
}
